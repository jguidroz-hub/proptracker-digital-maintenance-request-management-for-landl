...
const FROM = process.env.EMAIL_FROM || 'PropTracker - Digital maintenance request management for landlord-tenant communication <noreply@example.com>';
const APP_NAME = 'PropTracker - Digital maintenance request management for landlord-tenant communication';
