  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PropTracker - Digital maintenance request management for landlord-tenant communication</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Eliminates maintenance request chaos by providing transparent tracking, automated follow-ups, and accountability metrics that protect both landlords and tenants from disputes
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PropTracker - Digital maintenance request management for landlord-tenant communication.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PropTracker - Digital maintenance request management for landlord-tenant communication. All rights reserved.</p>
