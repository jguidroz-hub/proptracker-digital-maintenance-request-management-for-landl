  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="PropTracker - Digital maintenance request management for landlord-tenant communication-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
